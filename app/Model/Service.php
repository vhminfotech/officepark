...
class Service extends Model {
    ...
    public function getServiceData() {
        return Service::select(
                                'service.id', 'service.packages_name', 'service.category_id', 'service.website_id', 'category.categoryname'
                        )
    ...
    public function getServices($seviceId) {
        ...
        $service = Service::select(
                        'service.id', 'service.packages_name', 'service.category_id', 'service.website_id'
        ...
        $serviceDetail = ServiceDetail::select(
                        'service_detail.title', 'service_detail.qty', 'service_detail.price', 'service_detail.is_invoice', 'service_detail.total'
                )
...
//    GET DROPDOWN DATA
    public function getPackage() {
        $result = Service::pluck('packages_name', 'id')->toArray();
        return $result;
    }

var Invoice = function() {
    ...
    var handleAddInvoice = function() {
        ...
        $('body').on('change', '.selectpackege', function() {
            ...
            var url = baseurl + 'customer/customer-invoice-packege-detail';
    ...
    var handleList = function() {
        $('body').on('click', '.createBill', function() {
            ...
            if (value == '') {
                ...
                window.location.href = baseurl + 'customer/customer-add-invoice/' + value;
            }
        });
        ...
        $('body').on('click', '.yes-sure', function() {
            ...
            var url = baseurl + 'customer/customer-delete-invoice';
            ajaxcall(url, data, function(output) {
        ...
        $('body').on('change', '.changeStatus', function() {
            ...
            var url = baseurl + 'customer/customer-change-status';
            ajaxcall(url, data, function(output) {
                handleAjaxResponse(output);
            });
        });
        ...
        $('body').on('click', '.sendInvoice', function() {
            ...
            var url = baseurl + 'customer/customer-invoice-pdf';
            ajaxcall(url, data, function(output) {
                handleAjaxResponse(output);
            });
        });

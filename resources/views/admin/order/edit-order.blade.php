                ...
                <form class="orderStatus" name="orderStatus" action="{{ route('edit-order',array('id' => $arrOrder[0]->id,'userId' => $arrOrder[0]->user_id )) }}" id="orderStatus">
                    <div class="c-stage__panel u-p-medium">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="phone_to_reroute">Phone to Redirect</label> 
                                   <input  class="c-input  phone_to_reroute" value="{{ $arrOrder[0]->phone_to_reroute }}" id="phone_to_reroute" name='phone_to_reroute'>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="firstName">Welcome Message</label> 
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="surname">Unavailable Message</label> 
                            ...
                            <div class="col-lg-6">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="company">Reroute Confirm</label> 
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="position">Forward Message</label> 

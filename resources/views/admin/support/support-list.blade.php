                ...
                <table class="c-table table-responsive" id="datatable">
                    ...
                    <caption class="c-table__title">
                        <div class="row">
                            ...
                            <div class="right">
                                    <a href="{{route('add-support')}}" class="c-btn c-btn--info">Support Module Message Add</a>
                            </div>
                        </div>
                    </caption>
                    ...
                    <tbody>
                        ...
                        <tr class="c-table__row">
                            ...
                            <td class="c-table__cell"> 
                                ...
                                <a href="{{ route('supportchat',$val['id'])}}"  class=" btnPopup c-tooltip c-tooltip--top"  aria-label="View Chat" data-id="{{ $val['id'] }}">

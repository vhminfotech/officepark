                ...
                {{ Form::open( array('method' => 'post', 'class' => 'addoutgoingcalls','files' => true, 'id' => 'addoutgoingcalls' )) }}
                    ...
                    <div class="c-stage__panel u-p-medium">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="c-field u-mb-small">
                                    <label class="c-field__label" for="user">User</label> 
                                    
                                    <select class="c-select" id="select1 customer_id" name="customer_id" required>
                                        
                                        @for($i = 0; $i < count($users) ;$i++)
                                           <option   value="{{$users[$i]['id']}}" {{(isset($callList['customer_id']) && $callList['customer_id'] == $users[$i]['id']) ? 'selected="selected"' : ''  }} >{{$users[$i]['name']}}</option>

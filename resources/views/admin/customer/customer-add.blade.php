                ...
                <div class="col-12">
                    <div class="c-tabs">
                        ...
                        <div class="c-tabs__content tab-content" id="nav-tabContent">
                            <form name="addCustomer" id="addCustomer" action="{{ route('customer-add') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="c-field u-mb-small">
                                            ...
                                            <input class="c-input" id="firstName" name="customer_number" placeholder="CA021" type="text"> 
                                        </div>

                                        <div class="c-field u-mb-small">
                                            <label class="c-field__label" for="lastName">First Name</label> 
                                            <input class="c-input" id="first_name" name="first_name" placeholder="Clark" type="text"> 
                                        </div>
                                        ...
                                        <div class="c-field u-mb-small">
                                            ...
                                            <input class="c-input" id="email" name="email" placeholder="jason@clark.com" type="email">
                                        </div>
                                    ...
                                    <div class="col-lg-5">
                                        <div class="c-field u-mb-small">
                                            ...
                                            <input class="c-input" id="companyName" name="company_name" placeholder="Dashboard Ltd." type="text">
                                        </div>

                                        <div class="c-field u-mb-small">
                                            <label class="c-field__label" for="website">Last Name</label>
                                            <input class="c-input" id="last_name" name="last_name" placeholder="zawiastudio.com" type="text">
                                        </div>  

                                        <div class="c-field u-mb-small">
                                            <label class="c-field__label" for="website">Telefon</label>
                                            <input class="c-input" id="telephone" name="telephone" placeholder="zawiastudio.com" type="text">
                                        </div>  
                                    </div>
                                </div>
                                <div class="">
